...
{
    QSqlQueryModel* model = new QSqlQueryModel();
     model->setQuery("select  id,nom,sport,salle,prix_achat from equipement ORDER BY id ASC");
     model->setHeaderData(0, Qt::Horizontal, QObject::tr("ID"));
     model->setHeaderData(1, Qt::Horizontal, QObject::tr("Nom"));
     model->setHeaderData(2, Qt::Horizontal, QObject::tr("sport"));
     model->setHeaderData(2, Qt::Horizontal, QObject::tr("salle"));
...
{
    QSqlQueryModel* model = new QSqlQueryModel();
     model->setQuery("select  id,nom,sport,salle,prix_achat from equipement ORDER BY nom ASC");
     model->setHeaderData(0, Qt::Horizontal, QObject::tr("ID"));
     model->setHeaderData(1, Qt::Horizontal, QObject::tr("Nom"));
     model->setHeaderData(2, Qt::Horizontal, QObject::tr("sport"));
     model->setHeaderData(2, Qt::Horizontal, QObject::tr("salle"));
